...
public class StockExchange {
	...
	/**
	 * Places a trade order by calling <code>stock.placeOrder</code> for the stock specified by the stock symbol in the trade order. If the stock (ex. XYZ) is not found in the exchange's list of stocks, then the exchange sends a message to the trader with the message "XYZ not found".
